...
export const ContainerInformationSchema =
  SchemaFactory.createForClass(ContainerInformation);
...
export const PodInformationSchema =
  SchemaFactory.createForClass(PodInformation);
