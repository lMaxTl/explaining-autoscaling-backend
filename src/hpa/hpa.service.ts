...
export class HpaService {
   ...
   * @returns
   */
  async getHpaConfigurationByDeploymentName(
   ...
   * @returns
   */
  private async saveHpaMetadata(
    hpaConfigurations: k8s.V2beta2HorizontalPodAutoscaler[],
  ) {
    for (const hpaConfig of hpaConfigurations) {
   ...
   * @returns
   */
  private async saveExternalHpaMetadata(
    metric: k8s.V2beta2MetricSpec,
    hpaConfig: k8s.V2beta2HorizontalPodAutoscaler,
  ) {
   ...
   */
  private savePrometheusQueryInformation(
    hpaConfig: k8s.V2beta2HorizontalPodAutoscaler,
    hpa: Hpa &
   ...
   * @param hpaConfig
   */
  private async deploymentAllreadySaved(
    hpaConfig: k8s.V2beta2HorizontalPodAutoscaler,
  ) {
