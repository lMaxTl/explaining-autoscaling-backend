...
import {
  ClusterMetric,
  ClusterMetricSchema,
} from './schema/clusterMetric.schema';
...
} from './schema/scalingConditions.schema';
...
} from './schema/prometheusMetric.schema';
...
} from './schema/podInformation.schema';
import {
  DeploymentInformation,
  DeploymentInformationSchema,
} from './schema/deploymentInformation.schema';
@Module({
  imports: [
